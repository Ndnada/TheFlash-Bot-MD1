...
⬡ S: ${ago}
⬡ E: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽 VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/201098829097' },
...
title: `BOBIZ IS HERE ♥...`,
body:author,
sourceUrl: 'http://wa.me/201098829097', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
...
handler.command = /^اغاني|مهرجانات$/i
