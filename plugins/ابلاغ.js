...
if (!text) throw `*[❗تحذير❗] ادخل مشكلتك و بلاغك*\n\n*مثال:*\n*${usedPrefix + command} مرحباً اسكونر${usedPrefix}كيف اخبارك*`
...
conn.reply('201098829097@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, { contextInfo: { mentionedJid: [m.sender] }})
...
handler.tags = ['info']
handler.command = /^(report|مشكله|مشكلة|bug|report-owner|reportes)$/i
