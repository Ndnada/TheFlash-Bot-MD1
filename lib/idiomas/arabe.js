...
//إشعارات الرسائل
const smsAvisoRG = () => { return `╰⊱✅⊱ بطل بعبصه يحبيبي ⊱✅⊱╮\n\n` }
const smsAvisoAG = () => { return `╰⊱⚠️⊱ بطل بعبصه ي حبيبي ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ تم البعبصه ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ بطل بعبصه ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ ايوا افضل بعبص ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ بعبص برحتك ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ يعم بطل بعبصه ⊱💚⊱╮\n\n` }

//المعلمات في الأوامر
const smsRowner = () => { return `\`\`\`〔✘ بطل بعبصه ي حبيبي 〕\`\`\`` }
const smsOwner = () => { return `\`\`\`〔✘ كفايه بعبصه يحبي 〕\`\`\`` }
const smsMods = () => { return `\`\`\`〔✘ شكلك بتحب البعبصه 〕\`\`\`` }
const smsPremium = () => { return `\`\`\`〔✘  بس ي حبيبي بطل بعبصه 〕\`\`\`` }
const smsGroup = () => { return `\`\`\`〔✘ بطل بعبصه ي قلبي 〕\`\`\`` }
const smsPrivate = () => { return `\`\`\`〔✘ بطل بعبصه ي قلب داد 〕\`\`\`` }
const smsAdmin = () => { return `\`\`\`〔✘ بطل بعبصه ي قلبي〕\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`〔✘ ارفع البوت ادمن الاول وبطل بعبصه〕\`\`\`` }
const smsUnreg = () => { return `\`\`\`(لحظة !! انت متناك〕*\n\n*〔سجل الامر لكي يتم تفعيله〕\n➣ #تفعيل\`\`\`` }
const smsRestrict = () => { return `\`\`\`〔✘ طيب بطل بعبصه شوية〕\`\`\`` }
...
//handler.js
const smsCont1 = () => { return `*🔴 واحد بعبص في البوت🔴*`}
